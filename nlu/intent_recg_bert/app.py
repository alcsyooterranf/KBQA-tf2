...
class BertIntentModel(object):
    ...
    def __init__(self):
        ...
        self.dict_path = 'D:\PythonWorkSpace\Bert Model\chinese_L-12_H-768_A-12/vocab.txt'
        self.config_path = 'D:\PythonWorkSpace\Bert Model\chinese_L-12_H-768_A-12/bert_config.json'
        self.checkpoint_path = 'D:\PythonWorkSpace\Bert Model\chinese_L-12_H-768_A-12/bert_model.ckpt'
